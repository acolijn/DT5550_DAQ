...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1156, 668)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.detectorSettings = QtWidgets.QTableWidget(self.centralwidget)
        self.detectorSettings.setGeometry(QtCore.QRect(300, 190, 611, 261))
        ...
        self.globalSettings.setGeometry(QtCore.QRect(300, 110, 831, 51))
        ...
        self.run_stop.setGeometry(QtCore.QRect(20, 560, 211, 46))
        self.run_stop.setObjectName("run_stop")
        self.run_start = QtWidgets.QPushButton(self.centralwidget)
        self.run_start.setGeometry(QtCore.QRect(20, 500, 211, 46))
        ...
        self.line.setGeometry(QtCore.QRect(250, 30, 20, 591))
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.logWindow = QtWidgets.QTextBrowser(self.centralwidget)
        self.logWindow.setGeometry(QtCore.QRect(300, 470, 831, 141))
        ...
        self.open_geometry_button.setGeometry(QtCore.QRect(950, 190, 181, 46))
        self.open_geometry_button.setObjectName("open_geometry_button")
        self.progressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar.setGeometry(QtCore.QRect(20, 470, 211, 23))
