...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.channel_8 = QtWidgets.QCheckBox(self.splitter_2)
        self.channel_8.setObjectName("channel_8")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1370, 38))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.plotIt.setText(_translate("MainWindow", "Plot"))
        ...
        self.channel_5.setText(_translate("MainWindow", "channel 4"))
        self.channel_6.setText(_translate("MainWindow", "channel 5"))
        self.channel_7.setText(_translate("MainWindow", "channel 6"))
        self.channel_8.setText(_translate("MainWindow", "channel 7"))
